...
addon() {
  ...
  mkdir -p $ADDON_BUILD/$PKG_ADDON_ID/bin/
    ...
    # mmc-utils
    cp -P $(get_build_dir mmc-utils)/.install_pkg/usr/local/bin/mmc $ADDON_BUILD/$PKG_ADDON_ID/bin
